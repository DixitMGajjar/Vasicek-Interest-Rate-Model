...
def simulate_vasicek_paths(r0, a, b, sigma, T, n_steps, n_paths):
    """
    Simulate Vasicek interest rate paths using Euler-Maruyama discretization
    ...
    for t in range(1, n_steps + 1):
        ...
        # Optional: Apply reflection at zero to prevent negative rates
...
def analyze_model_fit(df, a, b, sigma, n_days=252):
    """Analyze how well the calibrated model fits the data"""
    dt = 1 / n_days
